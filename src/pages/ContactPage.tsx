  ...
  return (
    <>
      <main className="mx-[4%] border-t border-[#e5e7eb]">
        ...
        <div className="flex flex-col md:flex-row md:gap-x-13 md:mb-15 md:justify-evenly justify-center items-center">
          <img
            src="https://foreverbuy.in/assets/about_img-BAJyTXw9.png"
            alt=""
            className="mb-15 w-[95%] md:w-[40%] md:mb-0"
          />
          <div className="flex flex-col">
            <h2 className="text-xl text-[#4b5563] font-semibold mb-5">
              Our Store
            </h2>
            ...
            <button className="mt-6 mb-0 w-fit border px-7 py-3.5 text-sm cursor-pointer">
              Explore Jobs
            </button>
          </div>
        </div>
